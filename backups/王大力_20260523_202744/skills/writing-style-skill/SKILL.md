...
- **人工智能** → 替代: "AI" | 理由: 人类将全称替换为更简洁的英文缩写，符合口语化、直接的风格。
- **致力于** → 替代: 删除或使用更直接的动词（如“教”、“做”） | 理由: 人类倾向于避免正式、书面化的动词。
- **渗透到我们生活的方方面面** → 替代: 使用更直接、具体的表达（如“无处不在”） | 理由: 人类将这句略显陈词滥调的概括性描述替换为更简洁、有力的说法。
- **我们有理由相信** → 替代: 删除或使用更肯定的语气 | 理由: 人类删除了这句弱化语气的套话，使结论更果断。
- **将...发挥重要作用** → 替代: 使用更具体、有力的动词（如“改变”、“重塑”） | 理由: 该短语是模糊的展望性套话。
- **带来前所未有的变革** → 替代: 避免使用宏大、空洞的总结性短语 | 理由: 人类将整段展望替换为更务实、带有批判性的结论。
- **执行...任务** → 替代: 使用更具体的描述或口语化表达（如“干...活”、“做...事”） | 理由: 该短语显得抽象和冗长。

### 句式偏好

- （你喜欢的句式，比如：结论前置、不要学术导语）
- **标题应直接、有观点，避免中性陈述** | 理由: 人类将中性、教科书式的标题改为带有观点和吸引力的标题。
- **开篇应破除迷思，直接点明核心** | 理由: 人类摒弃定义开头，使用“别被...唬住。说白了，就是...”的句式，直接切入本质并拉近与读者的距离。
- **用具体、生活化的例子替代抽象的分类列举** | 理由: 人类将抽象例子（如“语音助手如Siri”）改为更具体、更贴近日常体验的例子（如“抖音为啥知道你喜欢啥？推荐算法”）。
- **增加批判性视角或提醒，避免一味乐观描述** | 理由: 人类会明确指出当前技术的局限性（如没有意识，只是模式匹配），使文章更客观、深刻。
- **结论应简洁、有力、有态度，避免空泛展望** | 理由: 人类将空泛的积极展望替换为观点鲜明且具有警示性的结论。
- **使用口语化、对话式的语言（如“说白了”、“为啥”、“这玩意”）** | 理由: 全文风格从学术性、正式转变为像朋友聊天一样直接、随意。
- **使用加粗强调核心观点** | 理由: 人类在结论中使用加粗来突出关键信息。
- **避免教科书式的定义开头** | 理由: 人类完全重写开篇段落，摒弃“XX是...的一个分支，致力于...”的标准定义模式。
- **避免中性的历史事件罗列** | 理由: 人类在介绍历史时加入叙事和评价，而非简单罗列事实。
- **避免使用“包括...等”的列举句式** | 理由: 这种列举显得刻板。人类改用更自然的融入方式介绍能力。
- **避免使用破折号“-”进行列举时，项目过于简短和孤立** | 理由: 人类使每个列举项本身就是一个完整的、有解释的句子。
